...
| `E13.vox` | 27×19×5 | 8.1×5.7×1.5 | 喷气式飞翼（YB-49 风）：HIGH 层弹墙轰炸（瓦片雄鹰 E13） |
| `E14.vox` / `E15.vox` | 13×15×5 | 3.9×4.5×1.5 | 零式战斗机（红/金两种涂装，同一机体）：全表最小（瓦片雄鹰 E14/E15） |
| `E16.vox` | 22×30×11 | 6.6×9.0×3.3 | 野牛气垫登陆艇：全表最宽最厚，气垫围裙 + 三导管桨 + 货舱载荷（瓦片雄鹰 E16，击沉放兵） |
|---|---|
