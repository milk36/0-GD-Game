...
| [tools-vox.html](tools-vox.html) | 体素工具链 tools/vox：MagicaVoxel ↔ Godot 工作流（文件清单/标准流程/核心约定/单位与海盗资产表/voxlib API/验证流程/踩坑速查；细节以 tools/vox/README.md 为准） |
| [ai-voxel-pipeline.html](ai-voxel-pipeline.html) | AI 驱动体素资产：方案评估与推荐架构（AI 介入四层级 L0~L3 对比/为何必须用编译器约束/声明式 spec 草案与 op 集合/编译器校验项/现有基建盘点/阶段 0~3 落地路径/风险边界；**当前状态：仅方案，未开工**） |
